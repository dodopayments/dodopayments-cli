export const COMMANDS = [
  ...
  { command: '/init',             description: 'Instantly scaffold Dodo Payments into Next.js, Express, or Better-Auth' },
  { command: '/init nextjs',      description: 'Scaffold Next.js App Router billing routes' },
  { command: '/init express',     description: 'Scaffold Express server billing routes' },
  { command: '/init better-auth', description: 'Scaffold Better-Auth plugin configuration' },
